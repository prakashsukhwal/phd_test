...
def app():
    ...
    if choice == 'Home':
        ...
        :orange[Also, it is slow due to running on free server. We request your patience while asking questions.]
        ...
        - **If you see that the agent is confused, or wandering off, or stuck in a loop then simply reset the chat and start again**.
        - In the worst case, clear the browser and re-start your conversation.
        - Please logout at the end of your conversation. Currently user conversations are not transferred to the next session due to resource constriants.
        ...
        **Note**:         
        ...
        if st.session_state['username'] is not None:
            ...
            def sys_prompt():
                ...
                system_message = SystemMessage(
                        ...
                        "A PhD student of NUS, named Prakash Sukhwal created you."
                                 ...
                                 "You Only answer questions about diseases and human user. Politely say 'sorry' to any other questions including questions about other humans."
            ...
            User: I have asthma. Is my brother prone to it?
            Assistant: Amit, I can only answer questions about you or diseases. For your friends and family, I cannot answer unless they talk to me like you do. 
            User: What is HIV?
